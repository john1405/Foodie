...
class _DetailedScreenState extends State<DetailedScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    body: Column(
      ...
      children: [appbBar(context),pizzaimage(),middledata(),footerdetails()],
    ),);
  }
...
Widget appbBar(BuildContext context){
  return Padding(
    ...
    child: Row( 
      children: [
        IconButton(icon: Icon(Icons.arrow_back_ios,color:Colors.black26),
         onPressed: (){
       ...
       Row(
         children: [
           ...
           Padding(
             ...
             child: Text(widget.queryDocumentSnapshot['ratings'],style: TextStyle(
         ...
         children: [
           Container(
             ...
             child: Text(
               ...
               style: TextStyle(fontSize: 36.0, color: Colors.grey.shade500, fontWeight: FontWeight.w400),
             ),
           ),
           Row(
             children: [
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Text(
                      'cheese',
                      style: TextStyle(color: Colors.grey.shade500, fontSize: 20.0),
                    ),
                    Row(
                      children: [
                        IconButton(
                          icon: Icon(EvaIcons.minus), onPressed: (){}),
                          Text('$cheesevalue',style: TextStyle(
                            fontSize: 20.0,color: Colors.grey.shade500
                          ),),
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        IconButton(
                          icon: Icon(EvaIcons.minus), onPressed: (){}),
                          Text('$baconvalue',style: TextStyle(
                            fontSize: 20.0,color: Colors.grey.shade500
                          ),),
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        IconButton(
                          icon: Icon(EvaIcons.minus), onPressed: (){}),
                          Text('$onionvalue',style: TextStyle(
                            fontSize: 20.0,color: Colors.grey.shade500
                          ),),
    ...
    children: [
      GestureDetector(
        ...
        child: Container(
          width: 250.0,
          height: 50.0,
          decoration: BoxDecoration(color: Colors.red.shade500, borderRadius: BorderRadius.circular(50.0)),
          child: Center(
            child: Text(
              'Add to cart',
      ...
      Stack(
          ...
          Positioned(left: 35,child: CircleAvatar(radius: 10,child: Text('$totalitems'),))        
        ] 
      ),
